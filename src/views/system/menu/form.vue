...
<template>
  ...
  >
    <el-row :gutter="30">
      ...
      <re-col
        v-if="newFormInline.permissionType !== 3"
        :value="12"
        :xs="24"
        :sm="24"
      >
      ...
      <re-col
        v-show="newFormInline.permissionType === 0"
        :value="12"
        :xs="24"
        :sm="24"
      >
      ...
      <re-col
        v-show="newFormInline.permissionType < 2"
        :value="12"
        :xs="24"
        :sm="24"
      >
      ...
      <re-col
        v-show="newFormInline.permissionType === 1"
        :value="12"
        :xs="24"
        :sm="24"
      >
      ...
      <re-col
        v-if="newFormInline.permissionType === 1"
        :value="12"
        :xs="24"
        :sm="24"
      >
